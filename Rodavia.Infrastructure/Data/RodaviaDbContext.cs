...
namespace Rodavia.Infrastructure.Data
{
    public partial class RodaviaDbContext : DbContext
    {
        public RodaviaDbContext(DbContextOptions<RodaviaDbContext> options) : base(options) { }
